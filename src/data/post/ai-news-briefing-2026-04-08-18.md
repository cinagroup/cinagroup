...
| Company/Event | Key Data | Source |
|---------------|----------|--------|
| Anthropic Annual Revenue Run Rate | $30 billion | CNMO |
| Anthropic Compute Deployment | 3.5 GW | CNMO |
| GLM-5.1 Parameter Scale | 754B | Aibase |
| GLM-5.1 Autonomous Task Duration | 8 hours | Creati.ai |
| Chinese Models Weekly Usage | 12.96T tokens | OpenRouter |
| US Models Weekly Usage | 3.03T tokens | OpenRouter |
| Global Top 6 Models | All from China | OpenRouter |
| Anthropic Enterprise Customers | 1,000+ | CNMO |

---

## 🌐 Further Reading

- [Anthropic Revenue Growth Analysis](https://ai.cnmo.com/news/806760.html)
- [GLM-5.1 Open-Source Model Details](https://creati.ai/ai-news/2026-04-08/glm-5-1-open-source-llm-8-hour-autonomous-agentic-claude-opus-4/)
- [Chinese Large Models Global Usage Data](https://ai.cnmo.com/news/806751.html)
- [DeepSeek Expert Mode Testing](https://ai.cnmo.com/news/806850.html)
- [360 XiaShu APP Introduction](https://ai.cnmo.com/news/806849.html)

---

**Briefing Generated By**: AI News Briefing System  
**Next Update**: 2026-04-09 06:00

---

*This briefing is automatically generated, covering core AI developments from the past 12 hours.*
