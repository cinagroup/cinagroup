...
| Domain | Trend | Signal |
|--------|-------|--------|
| **LLM Competition** | Open-weights Chinese models beating frontier labs in coding tasks | 🔴 Hot |
| **AI Developer Tools** | Enterprise AI coding spend exploding beyond budget forecasts | 🔴 Hot |
| **AI Security** | Major AI labs building both attack (Mythos) and defense (Claude Security) tools | 🟡 Rising |
| **Content Authenticity** | Platforms (Spotify, Oscars) creating human-vs-AI verification systems | 🟡 Rising |
| **Autonomous Vehicles** | Regulatory enforcement catching up to AV deployment | 🟡 Rising |
