...
| Domain | Trend | Signal |
|---|---|---|
| **Legal / Governance** | Musk v. Altman trial exposes systemic board failures at OpenAI | 🔴 High |
| **AI Agent Architecture** | Anthropic Dreams enable self-improving agent memory systems | 🟢 Emerging |
| **Compute Infrastructure** | Anthropic + SpaceX 300MW deal; orbital AI compute on the table | 🔴 High |
| **Open Standards** | OpenAI open-sources MRC networking protocol with 5 partners | 🟡 Growing |
| **Corporate Consolidation** | SpaceXAI merger creates $1.25T entity; orbital data centers planned | 🔴 High |
